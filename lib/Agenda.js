      ...
      (_ret =
        ...
        (_this.renderDay = function(day, events, dayKey) {
          ...
          events = events.filter(function(e) {
            return (0,
            _eventLevels.inRange)(e, _dates2.default.startOf(day, 'day'), _dates2.default.endOf(day, 'day'), _this.props)
          })
...
Agenda.title = function(start, _ref4) {
  var _ref4$length = _ref4.length,
    length =
      _ref4$length === undefined ? Agenda.defaultProps.length : _ref4$length,
